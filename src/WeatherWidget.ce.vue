...
import { Settings, CitiesList } from "@/components";
import { ref } from "vue";

const isOpenedSettings = ref<boolean>(false);

</script>

<template>
    <main class="main">
        <button class="main__settings" aria-label="Setup locations" @click="isOpenedSettings = !isOpenedSettings">
            <svg v-if="!isOpenedSettings" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg v-else viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
        ...
        <keep-alive>
            <Settings v-if="isOpenedSettings" />
            <CitiesList v-else />
        </keep-alive>
    </main>
</template>
